...
export const SITE_DESC =
  "AI assistant for the EU Markets in Crypto-Assets Regulation (MiCA, Regulation (EU) 2023/1114): " +
  "grounded, article-cited answers, a token & service classifier, and an ESMA register lookup.";
export const REPO_URL = "https://github.com/exas-3/mica-copilot";
